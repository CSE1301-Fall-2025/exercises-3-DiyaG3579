...
public class Car
{
   ...
   {
      model = "Subaru Legacy";
      year = 2019; //tance variables to default values "" and 2019
   ...
   {
      model = initModel;// 2. set the instance variables to the init parameter variables
      year = initYear;
   ...
   public static void main(String[] args)
   {
      ...
      Car car1 = new Car();
      Car car2 = new Car("Subaru Outback", 2024);
